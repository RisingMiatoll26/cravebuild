...
echo "Cleaning up old leftover repos… they were useless anyway."
...
repo init -u https://github.com/RisingMiatoll26/android -b sixteen --git-lfs
...
git clone https://github.com/RisingMiatoll26/vendor_xiaomi_miatoll.git -b 16 vendor/xiaomi/miatoll
echo -e ">>> Done"
...
git clone https://github.com/RisingMiatoll26/hardware_xiaomi.git -b 16 hardware/xiaomi
echo -e ">>> Done"

echo -e ">>> Cloning Additional Hardware Trees"
git clone https://github.com/RisingMiatoll26/android_hardware_sony_timekeep.git -b lineage-23.0 hardware/sony/timekeep
echo -e ">>> Done"
